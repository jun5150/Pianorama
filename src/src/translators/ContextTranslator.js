/**
 * PIANORAMA - ContextTranslator.js (v12.1)
...
window.ContextTranslator = {
    ...
    /**
     * Inicializa o contexto. Substitui o padrão (key = "C") por verificação manual.
     */
    init: function(key) {
        var targetKey = key || "C";
    ...
    setContext: function(key) {
        this.currentKey = key;
        // Acesso defensivo aos motores globais
        if (window.TheoryEngine) {
    ...
    translate: function(midi, targetLetter) {
        ...
        // Correção de oitava visual para evitar saltos na pauta
    ...
    _getAccidentalForLetter: function(pc, targetLetter) {
        ...
        var basePc = letterBaseMap[targetLetter.toUpperCase()];
        var diff = pc - basePc;
    ...
    _getFileName: function(letter, accidental, octave) {
        ...
        // Substituindo Template String por concatenação clássica

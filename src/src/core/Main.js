...
window.App = {
    ...
    handleSelection: async function(lessonId) {
        ...
        // Persiste o ID como string (ex: "field:major")
        mainCard.dataset.id = lessonId; 
    
        var parts = lessonId.split(':');
        // Verifica se é campo harmônico ou escala para definir a pasta de áudio
        mainCard.dataset.folder = (parts === 'field') ? 'chords' : 'scales';
